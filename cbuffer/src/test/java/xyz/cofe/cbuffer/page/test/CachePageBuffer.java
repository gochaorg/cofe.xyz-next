 ...
 * </ul>
 */
public class CachePageBuffer implements AutoCloseable, ContentBuffer {
     ...
     */
    public CachePageBuffer( ContentBuffer hiBuffer, ContentBuffer loBuffer, int pageSize, int maxHiPages ){
        ...
        if( "true".equalsIgnoreCase(System.getProperty("xyz.cofe.cbuffer.page.test.CachePageBuffer.log","false")) ) {
