 ...
 */
public interface Tuple15<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O> {
    /**
     ...
     * @param <N> тип 14го элемента
     * @param <O> тип 15го элемента
     * @return 15ка значений
     */
    static <A,B,C,D,E,F,G,H,I,J,K,L,M,N,O> Tuple15<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O>
    of(
        A a, B b, C c, D d, E e,
        F f, G g, H h, I i, J j,
        K k, L l, M m, N n, O o
     ...
     * @return self ссылка
     */
    default Tuple15<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O> apply(
        Consumer15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
            consumer
    ){
     ...
     */
    default <Z> Z apply( Fn15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Z> fn ){
