 ...
 */
public interface Tuple17<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q> {
    /**
     ...
     */
    public static class Tuple17Impl<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q> implements Tuple17<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q>, Serializable {
        private final A a;
        private final B b;
        private final C c;
        private final D d;
     ...
     * @param <P> тип 16го элемента
     * @param <Q> тип 17го элемента
     * @return 17ка значений
     */
    static <A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q> Tuple17<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q>
    of(
        A a, B b, C c, D d, E e,
        F f, G g, H h, I i, J j,
        K k, L l, M m, N n, O o,
     ...
     * @return self ссылка
     */
    default Tuple17<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q> apply(
        Consumer17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>
            consumer
    ){
     ...
     */
    default <Z> Z apply( Fn17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, Z> fn ){
     ...
     * @return Кортэж
     */
    default <R> Tuple18<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R> add(R r){
        return Tuple.of(a(),b(),c(),d(),e(),f(),g(),h(),i(),j(),k(),l(),m(),n(),o(),p(),q(),r);
    }
}
