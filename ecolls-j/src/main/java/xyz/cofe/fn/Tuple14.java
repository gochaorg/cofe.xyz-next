...
public interface Tuple14<A,B,C,D,E,F,G,H,I,J,K,L,M,N> {
     ...
     * @param <M> тип 13го элемента
     * @param <N> тип 14го элемента
     * @return 14ка значений
     */
    static <A,B,C,D,E,F,G,H,I,J,K,L,M,N> Tuple14<A,B,C,D,E,F,G,H,I,J,K,L,M,N>
    of(
        A a, B b, C c, D d, E e,
        F f, G g, H h, I i, J j,
        K k, L l, M m, N n
     ...
     * @return self ссылка
     */
    default Tuple14<A,B,C,D,E,F,G,H,I,J,K,L,M,N> apply(
        Consumer14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>
            consumer
    ){
     ...
     */
    default <Z> Z apply( Fn14<A, B, C, D, E, F, G, H, I, J, K, L, M, N, Z> fn ){
