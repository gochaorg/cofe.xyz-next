...
public interface Tuple13<A,B,C,D,E,F,G,H,I,J,K,L,M> {
     ...
     */
    public static class Tuple13Impl<A,B,C,D,E,F,G,H,I,J,K,L,M> implements Tuple13<A,B,C,D,E,F,G,H,I,J,K,L,M>, Serializable {
        private final A a;
        private final B b;
        private final C c;
        private final D d;
