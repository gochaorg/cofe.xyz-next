...
public class GraphIterator<N,E> implements Iterator<Path<N,E>> {
     ...
     * Подписки
     */
    protected final ListenersHelper<GraphIteratorListener<N,E>,GraphIteratorEvent<N,E>> listeners;
     ...
     * @return подписчики
     */
    public Set<GraphIteratorListener<N,E>> getListeners() {
     ...
     */
    public AutoCloseable addListener(GraphIteratorListener listener) {
     ...
     * @return отписаться от событий
     */
    public AutoCloseable addListener(GraphIteratorListener listener, boolean weakLink) {
     ...
     * @return Отписка
     */
    public <EventType extends GraphIteratorEvent> AutoCloseable listen(
            final Class<EventType> evType,
            final Consumer<EventType> listener
    ){
        ...
        return addListener(new GraphIteratorListener() {
            ...
            public void graphIteratorEvent(GraphIteratorEvent event) {
                ...
                if( event.getClass().equals(evType) ){
                    listener.accept((EventType)event);
                }
            }
        });
    }
    ...
    public GraphIterator(
        ...
        this.listeners = new ListenersHelper<GraphIteratorListener<N,E>,GraphIteratorEvent<N,E>>((GraphIteratorListener<N, E> ls, GraphIteratorEvent<N, E> ev) -> {
                        if( ls!=null ){
                            //try{
        ...
        this.poller = poller;
        this.pusher = pusher;
        this.visited = new BasicEventSet<N>(new LinkedHashSet<N>());
    ...
    public GraphIterator( StoredState<N,E> sstate, Object sync ){
        ...
        if( visitd==null )visitd = new BasicEventSet<>(new LinkedHashSet());
        this.visited = visitd;
    }
    //</editor-fold>
     ...
     * @param syncCode код
     */
    public void sync( Consumer<GraphIterator<N,E>> syncCode ){
        if( syncCode==null )throw new IllegalArgumentException("syncCode");
        synchronized( sync ){
            syncCode.accept(this);
        }
    }
