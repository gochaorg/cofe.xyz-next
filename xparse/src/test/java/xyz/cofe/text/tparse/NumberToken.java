...
public class NumberToken extends CToken {
    ...
    public DigitsToken integerDigits(){ return integerPart; }
    public Optional<DigitsToken> floatDigits(){ return integerPart==null ? Optional.empty() : Optional.of(integerPart); }

    public boolean isFloat(){ return floatPart!=null; }
