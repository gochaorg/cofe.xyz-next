...
public class CSVDesc {
            ...
            synchronized(src){
                ...
                if( src.fixedColumns!=null ){
                    if( fixedColumns!=null ){
                        ...
                        fixedColumns = new ArrayList<FixedColumn>();
                    }
                    for( FixedColumn fc : src.fixedColumns ){
                        if( fc!=null ){
                            fixedColumns.add(fc.clone());
                        }else{
                            fixedColumns.add(null);
                        }
                    }
                }
            }
     ...
     * @param cellDelimiter Разделитель между ячейчами строки (Обычно запятая)
     */
    ...
    //<editor-fold defaultstate="collapsed" desc="fixedColumns - Перечень фикс. колонок">
    /**
    ...
    /**
     * Указывает перечень фиксированных колонок
     * @param fixedColumns Перечень фикс. колонок
     */
